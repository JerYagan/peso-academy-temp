ALTER TABLE public.analytics_user_daily
  ADD COLUMN IF NOT EXISTS session_count INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS session_learning_minutes INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS incomplete_sessions INTEGER NOT NULL DEFAULT 0;

ALTER TABLE public.analytics_course_daily
  ADD COLUMN IF NOT EXISTS session_count INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS session_learning_minutes INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS incomplete_sessions INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS revisit_rate NUMERIC(6,2) NOT NULL DEFAULT 0;

ALTER TABLE public.analytics_module_daily
  ADD COLUMN IF NOT EXISTS session_count INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS incomplete_sessions INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS revisit_rate NUMERIC(6,2) NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS session_learning_minutes INTEGER NOT NULL DEFAULT 0;

ALTER TABLE public.analytics_recommendation_daily
  ADD COLUMN IF NOT EXISTS refreshes INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS downstream_module_sessions INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS downstream_assessments INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS downstream_learning_minutes INTEGER NOT NULL DEFAULT 0;

ALTER TABLE public.analytics_admin_daily
  ADD COLUMN IF NOT EXISTS session_count INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS session_learning_minutes INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS incomplete_sessions INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS recommendation_refreshes INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS downstream_recommendation_sessions INTEGER NOT NULL DEFAULT 0;
