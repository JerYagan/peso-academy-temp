-- Consolidate trainer/admin visibility fixes for enrollments, certificates,
-- assessment attempts, and module sessions under the current role model.
-- Also add manager-safe RPC helpers used by trainer analytics screens.
