        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl animate-fade-up" style={{ animationDelay: "0.2s" }}>
              Free skills training, certifications, and job matching for Filipino workers. 
              Bridge the skills gap and find your dream career.
            </p>
              ...
              <div className="bg-card rounded-2xl card-shadow p-6 max-w-md ml-auto">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">TESDA Accredited</p>
                  </div>
                </div>
