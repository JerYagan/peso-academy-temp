...
const roles = [
  {
    ...
    description: "Access free training, build your skills portfolio, earn certifications, and get matched with employers looking for your talents.",
    features: ["Free courses & certifications", "Skills assessment", "Job matching", "Career guidance"],
    cta: "Start Learning",
  ...
  },
  {
    ...
    description: "Manage users, monitor training outcomes, track employment rates, and generate compliance reports for DOLE and LGUs.",
